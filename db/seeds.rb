...
testuser1 = User.create!(email: "elisa@gmail.com", password: "watchlist")
testuser2 = User.create!(email: "frankie@gmail.com", password: "watchlist")

puts "Created my two users"
movies = [
...
movies.each do |movie|
  created_movie = Movie.create!(movie)
  puts "Created movie: #{created_movie.title}"
end

puts "Finished seeding! Total movies: #{Movie.count}"
